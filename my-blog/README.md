Pavani Rajula - Easy & Simple Theme for Personal Blog
======
Pavani Rajula is an easy and simple theme for Jekyll. Dark colors, give it a special exquisite look. A careful approach to design and features make it an ideal solution for a personal blog.
...
Check the theme in action [Demo](https://artemsheludko.github.io/Pavani Rajula/)

![Main page preview](https://github.com/artemsheludko/Pavani Rajula/blob/master/img/Pavani Rajula-main-page.jpg?raw=true)

The post page would look like this:

![Post page preview](https://github.com/artemsheludko/Pavani Rajula/blob/master/img/Pavani Rajula-post.jpg?raw=true)
...
Pavani Rajula Theme comes with Disqus comments enabled.
